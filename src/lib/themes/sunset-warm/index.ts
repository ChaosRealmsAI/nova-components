 ...
 *
 * Design Philosophy:
 * - Style: Warm sunset colors, orange-red tones
 * - Corners: Very rounded (xl/2xl), cozy feel
 * - Effects: Warm glow, gradient transitions
 */
export const sunsetWarmTheme: ThemeDefinition = {
  id: 'sunset-warm',
  name: 'Sunset Warm',
  nameKey: 'themeNameSunsetWarm',
