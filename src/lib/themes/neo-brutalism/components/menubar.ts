export const menubarConfig = {
  slots: {
    root: 'flex h-10 items-center space-x-1 rounded-md border-2 border-black bg-background p-1 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]',
    ...
    content: 'z-50 min-w-[12rem] overflow-hidden rounded-md border-2 border-black bg-background p-1 text-foreground shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] data-[state=open]:animate-in data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2',
