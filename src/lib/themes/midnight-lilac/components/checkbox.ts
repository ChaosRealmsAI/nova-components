...
export const checkboxConfig = {
  slots: {
    base: [
      'peer h-5 w-5 shrink-0', // Slightly larger for touch
      'rounded-md', // Softer corners
      'border border-primary',
      'bg-surface-1', // Distinct background
      ...
      'data-[state=checked]:shadow-[0_0_10px_var(--primary-muted)]', // Glow when checked
    ],
