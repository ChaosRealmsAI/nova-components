/**
 * Dropdown Menu Component Style - Soft Clay
 *
 * ═══════════════════════════════════════════════════════════════════════════
 * Core Concept: "Floating Menu with Soft Shadows" (柔和凸起的浮动菜单)
 * - Shape: Medium rounded corners (16px)
 * - Border: No border (neumorphic relies on shadows)
 * - Shadow: Raised shadow (floating above surface)
 * - Item Hover: Subtle raised effect with gradient background
 * - Separator: Inset line effect
 * ═══════════════════════════════════════════════════════════════════════════
 */
