...
export const sheetConfig = {
  slots: {
    ...
    content: [
      "fixed z-50 gap-4 bg-surface-1 p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
      "border-l border-l-border border-r border-r-border", // Borders
    ...
    title: "text-lg font-semibold text-foreground uppercase tracking-wider",
