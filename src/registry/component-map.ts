...
import { ChartDemo, chartBaseConfig } from '@/components/nova-ui/blocks/chart';
...
export const COMPONENT_MAP: Record<string, ComponentMapEntry> = {
  ...
  'chart': { component: ChartDemo, baseConfig: chartBaseConfig },
