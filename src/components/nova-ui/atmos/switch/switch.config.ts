/**
 * Switch Base Config - ADR-001 标准 Tailwind 类
 */
export const switchBaseConfig = {
  slots: {
    ...
    thumb: 'pointer-events-none block rounded-full ring-0 transition-transform bg-background data-[state=unchecked]:translate-x-0',
  },
  variants: {
    variant: {
      default: { base: '' },
